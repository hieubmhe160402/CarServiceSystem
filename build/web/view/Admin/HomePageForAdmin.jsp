...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card { background:#fff; border-radius:12px; padding:18px; box-shadow: 0 4px 14px rgba(16,24,40,0.04); }
    .card .value { font-size:24px; font-weight:700; }
    .card .label { color:#6b7280; margin-top:8px; }

    /* Charts + tables area */
    .panels { display:grid; grid-template-columns: 2fr 1fr; gap:16px; margin-bottom:18px; }
    .chart { height:260px; padding:18px; }
    .chart .chart-placeholder{ width:100%; height:200px; background: linear-gradient(90deg, rgba(59,130,246,0.12), rgba(59,130,246,0.05)); border-radius:8px; display:flex; align-items:center; justify-content:center; color:#2563eb; font-weight:600; }

    .tables { display:grid; grid-template-columns: 1fr 1fr; gap:16px; }
    table { width:100%; border-collapse:collapse; background:#fff; border-radius:8px; overflow:hidden; }
    table thead th { text-align:left; padding:12px 16px; background:#f8fafc; color:#374151; border-bottom:1px solid #eef2f7; }
    table tbody td { padding:12px 16px; border-bottom:1px solid #f1f5f9; color:#374151; }
