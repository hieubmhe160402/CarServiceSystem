...
<head>
    ...
    <style>
        /* ===== GIỮ NGUYÊN PHẦN SIDEBAR VÀ CƠ BẢN ===== */
body {
    margin: 0;
...
/* ===== SUGGEST SECTION - Hiện đại và nổi bật ===== */
.suggest-section {
...
/* ===== PACKAGE CARDS - Hiện đại và đẹp mắt ===== */
.package-card {
    background: white;
    border-radius: 16px;
...
<div class="app">
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="<%= recommended.getImage() != null ? recommended.getImage() : "images/default-package.jpg" %>"
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success"><i class="fas fa-check-circle"></i> Chọn gói này</button>
    ...
    <input type="text" name="searchBrand" placeholder="Nhập hãng xe (VD: Toyota, Honda...)" 
           value="${searchBrand}" style="padding:8px; width:250px;">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="package-card">
                    <img src="<%= pkg.getImage() != null ? pkg.getImage() : "images/default-package.jpg" %>" alt="<%= pkg.getName() %>">
                    <div class="card-body">
                        <h5><%= pkg.getName() %></h5>
            ...
            <div class="modal fade" id="detailModal<%= pkg.getPackageId() %>" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="<%= pkg.getImage() != null ? pkg.getImage() : "images/default-package.jpg" %>"
                                 class="img-fluid mb-3 rounded">
