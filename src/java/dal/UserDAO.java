...
public class UserDAO extends DBContext {
    ...
    public List<User> getAllUsersWithRole() throws SQLException {
        List<User> list = new ArrayList<>();

        String sql = "SELECT u.UserID, u.UserCode, u.FullName, u.Username, u.Password, " +
                     "u.Email, u.Phone, u.Image, u.Male, u.DateOfBirth, " +
